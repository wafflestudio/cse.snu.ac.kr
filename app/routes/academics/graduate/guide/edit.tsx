import type { Route } from '.react-router/types/app/routes/academics/graduate/guide/+types/edit';
...
export default function GraduateGuideEditPage({
  ...
  const onSubmit = async (data: GuideFormData) => {
    ...
    try {
      ...
      navigate('/academics/graduate/guide');
    ...
    <PageLayout titleSize="xl">
      <FormProvider {...methods}>
        <Form>
          ...
          <Form.Action
            onCancel={() => navigate('/academics/graduate/guide')}
