import type { Route } from '.react-router/types/app/routes/admissions/international/+types/scholarships';
...
export async function loader({ request }: LoaderFunctionArgs) {
  ...
  const data = await fetchAdmissions('international', 'scholarships');
