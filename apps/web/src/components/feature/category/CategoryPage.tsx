...
export default function CategoryPage({
  ...
  return (
    <div className="bg-neutral-850">
      <Header />
      <div className="max-w-7xl px-5 py-8 shell:px-25 shell:pb-18 shell:pt-12">
        <div className="mb-2 text-sm font-normal text-neutral-500 shell:text-[20px]">
          {subtitle}
        </div>
        <div className="text-[32px] font-semibold tracking-wide text-white shell:text-[64px]">
          {resolvedTitle}
        </div>
        {description && (
          <Description
            className="mb-6 mt-8 hidden shell:block"
      ...
      {description && (
        <div className="px-5 pb-14 pt-7 shell:hidden">
