...
const noticeTagPillClass = (selected: boolean) =>
  clsx(
    'inline-flex min-h-8 cursor-pointer select-none items-center justify-center rounded-full border border-solid border-main-orange-muted px-3 py-1 text-md/5 font-medium transition duration-200',
