...
const PADDING_CLASSES: Record<Padding, string> = {
  default: 'page-gutter-x pb-12 pt-7 shell:py-11',
  subNav: 'page-gutter-x pb-12 pt-7 shell:pt-11 shell:pb-[150px]',
  overviewTop: 'page-gutter-x pb-12 pt-7 shell:py-11',
  overviewBottom: 'page-gutter-x pb-16 pt-10 shell:pb-[7.88rem]',
};
