...
function ReservationPrivacyPolicyPage() {
  ...
  return (
    ...
    >
      <HTMLViewer html={loaderData} />
    </PageLayout>
  );
}

export const Route = createFileRoute('/$locale/reservations/privacy-policy')({
  loader: async () => {
    ...
    return await prepareHtmlForViewer({ data: HTML_CONTENT });
  },
  component: ReservationPrivacyPolicyPage,
});
